...
exports.readOneMethod = async (query) => {
    try {
        const foundData = await OccupationModel.findOne(query);
        return foundData;
    } catch (err) {
        console.log('[METHOD-ERROR]: ', err);
        throw new Error(err);
...
exports.readManyMethod = async (query) => {
    try {
        const foundData = await OccupationModel.find(query);
        return foundData;
    } catch (err) {
        console.log('[METHOD-ERROR]: ', err);
        throw new Error(err);
...
exports.updateOneMethod = async (query, updatingData) => {
    try {
        const updatedData = await OccupationModel.findOneAndUpdate(query, updatingData);
        return updatedData;
    } catch (err) {
        console.log('[METHOD-ERROR]: ', err);
        throw new Error(err);
...
exports.updateManyMethod = async (query, updatingData) => {
    try {
        const updatedData = await OccupationModel.updateMany(query, updatingData);
        return updatedData;
    } catch (err) {
        console.log('[METHOD-ERROR]: ', err);
        throw new Error(err);
...
exports.deleteOneMethod = async (query) => {
    try {
        const deletedData = await OccupationModel.findOneAndDelete(query);
        return deletedData;
    } catch (err) {
        console.log('[METHOD-ERROR]: ', err);
        throw new Error(err);
...
exports.deleteManyMethod = async (query) => {
    try {
        const deletedData = await OccupationModel.deleteMany(query);
        return deletedData;
    } catch (err) {
        console.log('[METHOD-ERROR]: ', err);
        throw new Error(err);
